...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.record_updated'
        db.add_column(u'analytics_article', 'record_updated',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.record_updated'
        db.delete_column(u'analytics_article', 'record_updated')

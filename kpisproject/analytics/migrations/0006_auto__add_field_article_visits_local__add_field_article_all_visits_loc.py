...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.visits_local'
        db.add_column(u'analytics_article', 'visits_local',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Article.all_visits_local'
        db.add_column(u'analytics_article', 'all_visits_local',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.visits_local'
        db.delete_column(u'analytics_article', 'visits_local')

        # Deleting field 'Article.all_visits_local'
        db.delete_column(u'analytics_article', 'all_visits_local')
    ...
    models = {
        u'analytics.article': {
            ...
            'all_visits_local': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'visits_local': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        u'analytics.byline': {
